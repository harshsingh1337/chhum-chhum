  ...
  return (
    <div className="page active">
      <section style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', padding: '6rem 2rem', textAlign: 'center' }}>
        <img src={vercelImageUrl('/images/logo.jpeg', { w: 240 })} alt="ChhumChhum" style={{ width: '120px', height: '120px', borderRadius: '50%', objectFit: 'cover', marginBottom: '2.5rem', boxShadow: '0 8px 40px rgba(0,0,0,0.1)' }} />
